...
_G.ART = ART
local addon = { ART = ART }
local map = assert(loadfile(root.."/Raids/TBC/Maps/MagtheridonsLair.lua"))("AnniversaryRaidTools", addon)
local transform = assert(loadfile(root.."/Raids/TBC/Transforms/MagtheridonsLair.lua"))("AnniversaryRaidTools", addon)
