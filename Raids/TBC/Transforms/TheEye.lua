...
local transform = { schemaVersion = 1, raidKey = "the-eye", calibrations = {
  [1] = { mapId = 550, sublevel = 1, offsetX = 0, offsetY = 0, scaleX = 1, scaleY = 1, flipY = false, tolerance = 0.0005, provenance = provenance },
} }
...
local function selectCalibration(mapId, sublevel, calibration)
  if mapId ~= 550 then return nil, "unknown-map-id" end
