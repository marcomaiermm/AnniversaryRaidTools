...
local transform = { schemaVersion = 1, raidKey = "serpentshrine-cavern", calibrations = {
  [1] = { mapId = 548, sublevel = 1, offsetX = 0, offsetY = 0, scaleX = 1, scaleY = 1, flipY = false, tolerance = 0.0005, provenance = provenance },
} }
...
local function selectCalibration(mapId, sublevel, calibration)
  if mapId ~= 548 then return nil, "unknown-map-id" end
