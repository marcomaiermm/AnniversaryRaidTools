...
local Type, Version = "ARTNewPullButton", 1
...
local methods = {
  ...
  ["Initialize"] = function(self)
    ...
    function self.callbacks.OnClickNormal(_, mouseButton)
      if not ART.main_frame.sidePanel.pullButtonsScrollFrame.frame:IsMouseOver() then return end
...
local function Constructor()
  local name = "ARTNewPullButton"..AceGUI:GetNextWidgetNum(Type);
